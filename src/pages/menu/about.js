        ...
        <div className="w-screen">
          <section>
            <div className="py-10 sm:flex justify-between text-center">
              <h1 className="text-3xl text-dark dark:text-gray-300 sm:text-5xl font-medium">About Me</h1>
            ...
            <div className="text-center sm:text-start space-y-5 text-dark dark:text-gray-400">
              ...
              <p>
              learning and discovery from my journey as a student in the pplg department. Join me as we dive into the ever-exciting world of technology, where every line of code has the potential to advance digital development in incredible ways.
              </p>
              <p>
