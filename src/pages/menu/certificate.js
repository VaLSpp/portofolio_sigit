    ...
    <>
      ...
      <div className="py-10 sm:px-10 w-full dark:bg-gray-900 h-screen">
        ...
        <div className="pt-10 dark:border-b-gray-500">
          ...
          <p className="text-center py-2 sm:text-start text-gray-500 text-sm sm:text-md">Some of the certificates I received from organizations were in the form of problem solving and basic learning.</p>
          ...
          <div className="dark:bg-gradient-to-r dark:from-gray-900 dark:to-blue-500">
            <div className="container-certificate">
              ...
              >
                <SwiperSlide>
                  <Link href="/images/certificate/serti1.jpg">
                    <Image src="/images/certificate/serti1.jpg" alt="picture1" width={500} height={500} />
                  </Link>
                </SwiperSlide>
                <SwiperSlide>
