        ...
        <ul className="py-2 text-sm  text-gray-700 dark:text-gray-200" aria-labelledby="doubleDropdownButton">
          <ol className="relative border-l border-gray-200 dark:border-gray-700">
            ...
            <li className="mb-5 ml-8">
              ...
              <h3 className="flex items-center mb-1 text-sm font-semibold text-gray-900 dark:text-white">SMKN 1 CIOMAS</h3>
              <time className="block mb-3 text-xs font-normal leading-none text-gray-400 dark:text-gray-500">2022 - 2025</time>
              <div className="mb-2 flex flex-col">
